    ...
    <body class="skin-blue-light fixed">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="index2.html" class="logo" id="bg-head-sidebar">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><b>A</b>LT</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b><img src="<?php echo Url::to("@web/web/images/logo.jpg") ?>" width="32"/></b> ประวัติผู้ป่วย</span>
                </a>
            ...
            <aside class="main-sidebar" id="bg-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a href="<?php echo Url::to(['']); ?>" data-toggle="tooltip" data-trigger="hover" title="Popover title" data-placement="top"><i class="fa fa-car text-red"></i> ข้อมูลรถ</a></li>
                        <li><a href="<?php echo Url::to(['']); ?>"><i class="fa fa-users text-yellow"></i> ข้อมูลคนขับ</a></li>
                        <li><a href="<?php echo Url::to(['']); ?>"><i class="fa fa-building text-aqua"></i> ข้อมูลลูกค้า</a></li>
                        <li><a href="<?php echo Url::to(['']); ?>"><i class="fa fa-bus text-green"></i> ประเภทรถ</a></li>
                        <li><a href="<?php echo Url::to(['']); ?>"><i class="fa fa-shopping-cart text-danger"></i> ประเภทสินค้า</a></li>
